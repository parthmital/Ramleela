...
const navItems = ["Home", "About", "Highlights", "Schedule", "Gallery"];
...
const Header = () => {
  ...
  return (
    <div className="flex items-center px-16-72 justify-between borderb-4-gold bg-red-dark Header">
      ...
      <div className="flex items-center gap-32 Hide">
        {navItems.map((item) => (
          <a
            key={item}
            href={`#${item}`}
            className={`text-yellow text-18 font-medium HeaderButton${
      ...
      <div
        className={`borderb-4-gold MobileNav ${
