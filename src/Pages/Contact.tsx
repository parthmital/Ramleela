...
const formFields = [
    ...
    { label: "Email Address" },
    { label: "Phone Number" },
    { label: "Your Message / Sponsorship Inquiry" },
];
...
const contactInfo = [
    {
        icon: (
            <svg fill="none" height={24} viewBox="0 0 24 24" width={24} xmlns="http://www.w3.org/2000/svg">
                <path d="M16 21V19C16 17.9391 15.5786 16.9217 14.8284 16.1716C14.0783 15.4214 13.0609 15 12 15H6C4.93913 15 3.92172 15.4214 3.17157 16.1716C2.42143 16.9217 2 17.9391 2 19V21" stroke="#991B1B" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} />
                <path d="M9 11C11.2091 11 13 9.20914 13 7C13 4.79086 11.2091 3 9 3C6.79086 3 5 4.79086 5 7C5 9.20914 6.79086 11 9 11Z" stroke="#991B1B" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} />
                <path d="M22 21V19C21.9993 18.1137 21.7044 17.2528 21.1614 16.5523C20.6184 15.8519 19.8581 15.3516 19 15.13" stroke="#991B1B" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} />
                <path d="M16 3.13C16.8604 3.35031 17.623 3.85071 18.1676 4.55232C18.7122 5.25392 19.0078 6.11683 19.0078 7.005C19.0078 7.89318 18.7122 8.75608 18.1676 9.45769C17.623 10.1593 16.8604 10.6597 16 10.88" stroke="#991B1B" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} />
            </svg>
        ),
    ...
    },
    {
        ...
        title: "Email",
        value: "info@chemburramleela.com",
    },
    {
        icon: (
            <svg fill="none" height={24} viewBox="0 0 24 24" width={24} xmlns="http://www.w3.org/2000/svg">
        ...
        title: "Venue",
        value: "Gandhi Maidan, Chembur, Mumbai, Maharashtra",
    },
];
        ...
        icon: (
            <svg fill="none" height={48} viewBox="0 0 48 48" width={48} xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_6_440)">
                    ...
                    <path d="M33.3422 30.9375L34.4062 24H27.75V19.4981C27.75 17.5999 28.6798 15.75 31.6613 15.75H34.6875V9.84375C34.6875 9.84375 31.941 9.375 29.3151 9.375C23.8331 9.375 20.25 12.6975 20.25 18.7125V24H14.1562V30.9375H20.25V47.7084C21.4905 47.9028 22.7443 48.0003 24 48C25.2557 48.0003 26.5095 47.9028 27.75 47.7084V30.9375H33.3422Z" fill="white" />
                </g>
                <defs>
        ...
        icon: (
            <svg fill="none" height={48} viewBox="0 0 48 48" width={48} xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_6_443)">
                    <path d="M36.75 0H11.25C5.0368 0 0 5.0368 0 11.25V36.75C0 42.9632 5.0368 48 11.25 48H36.75C42.9632 48 48 42.9632 48 36.75V11.25C48 5.0368 42.9632 0 36.75 0Z" fill="url(#paint0_radial_6_443)" />
                    <path d="M36.75 0H11.25C5.0368 0 0 5.0368 0 11.25V36.75C0 42.9632 5.0368 48 11.25 48H36.75C42.9632 48 48 42.9632 48 36.75V11.25C48 5.0368 42.9632 0 36.75 0Z" fill="url(#paint1_radial_6_443)" />
                ...
                <defs>
                    <radialGradient cx={0} cy={0} gradientTransform="translate(12.75 51.6969) rotate(-90) scale(47.5716 44.2453)" gradientUnits="userSpaceOnUse" id="paint0_radial_6_443" r={1}>
                        <stop stopColor="#FFDD55" />
                        <stop stopColor="#FFDD55" offset="0.1" />
                        <stop stopColor="#FF543E" offset="0.5" />
                        <stop stopColor="#C837AB" offset={1} />
                    </radialGradient>
                    <radialGradient cx={0} cy={0} gradientTransform="translate(-8.04019 3.45769) rotate(78.681) scale(21.2648 87.654)" gradientUnits="userSpaceOnUse" id="paint1_radial_6_443" r={1}>
                        ...
                        {contactInfo.map((info, idx) => (
                            <div key={info.title} className="flex items-center gap-24 align-stretch">
                                ...
                                <div className="flex flex-col gap-4">
                                    <p className="text-yellow font-bold text-20">{info.title}</p>
                                    <p className="text-white text-16">{info.value}</p>
                                </div>
                            </div>
                        ))}
                    </div>
