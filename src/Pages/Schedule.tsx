    ...
    const scheduleData = [
        {
            ...
            date: '22 Sept',
            title: 'Ram Janma',
            description: 'Birth of Lord Rama with traditional aarti',
            time: '7:00 PM',
            tag: 'Grand Opening Ceremony',
        },
        {
            day: 'Day 2',
            date: '23 Sept',
            title: 'Bal Leela',
            description: 'Childhood stories of Rama and Lakshmana',
            time: '7:00 PM',
            tag: "Children's Special",
        },
        {
            day: 'Day 3',
            date: '24 Sept',
            title: 'Swayamvar',
            description: 'The divine marriage ceremony',
            time: '7:00 PM',
            tag: 'Sita-Ram Wedding',
        },
        {
            day: 'Day 4',
            date: '25 Sept',
            title: 'Vanvas',
            description: 'Exile to the forest for 14 years',
            time: '7:00 PM',
            tag: 'Forest Journey Begins',
        },
        {
            day: 'Day 5',
            date: '26 Sept',
            title: 'Panchavati',
            description: "Encounter with Ravana's sister",
            time: '7:00 PM',
            tag: 'Surpanakha Episode',
        },
        {
            day: 'Day 6',
            date: '27 Sept',
            title: 'Sita Haran',
            description: "The golden deer and Sita's kidnapping",
            time: '7:00 PM',
            tag: "Sita's Abduction",
        },
        {
            day: 'Day 7',
            date: '28 Sept',
            title: 'Hanuman Milan',
            description: 'Alliance with the Vanar Sena',
            time: '7:00 PM',
            tag: 'Meeting Hanuman',
        },
        {
            ...
            date: '29 Sept',
            title: 'Lanka Dahan',
            description: "Hanuman's heroic mission to Lanka",
            time: '7:00 PM',
            tag: 'Burning of Lanka',
        },
        {
            day: 'Day 9',
            date: '30 Sept',
            title: 'Yuddha Kand',
            description: 'Epic war between good and evil',
            time: '7:00 PM',
            tag: 'The Great Battle',
        },
        {
            day: 'Day 10',
            date: '2 Oct',
            title: 'Ravana Vadh',
            description: 'Victory celebration & effigy burning',
            time: '7:00 PM',
            tag: 'Grand Finale - Ravana Dahan',
        },
    ];
    return (
