    ...
    <div className="flex px-72-128 flex-col items-center gap-24 bg-red-dark">
        ...
        <div className="flex px-24 flex-col items-center gap-16 align-stretch rounded-16 border-1-gold bg-black-25">
            ...
            <div className="flex gap-64 CountDown">
                <div className="flex flex-col items-center">
                    <p className="text-gold text-36 font-bold">61</p>
                    <p className="text-yellow text-14">Days</p>
                </div>
                <div className="flex flex-col items-center">
                    <p className="text-gold text-36 font-bold">20</p>
                    <p className="text-yellow text-14">Hours</p>
                </div>
                <div className="flex flex-col items-center">
                    <p className="text-gold text-36 font-bold">57</p>
                    <p className="text-yellow text-14">Minutes</p>
                </div>
                <div className="flex flex-col items-center">
                    <p className="text-gold text-36 font-bold">39</p>
                    <p className="text-yellow text-14">Seconds</p>
                </div>
            </div>
        </div>
        <div className="flex items-center gap-24 Buttons">
            ...
            <div className="flex px-20-40 items-center gap-16 rounded-full border-4-gold">
                ...
                <p className="text-gold text-20 font-bold">Sponsor This Event</p>
            </div>
        </div>
    </div>
);
